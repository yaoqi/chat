...
import com.mercury.chat.user.entity.OrderSummaryTemplate.Criteria;
import com.mercury.chat.user.entity.OrderSummaryTemplate.Criterion;
...
public class OrderSummarySqlProvider {
    ...
    public String selectByExample(OrderSummaryTemplate example) {
        BEGIN();
    ...
    protected void applyWhere(OrderSummaryTemplate example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
